...
export const metadata = {
  title: "Céline Castronovo - Psychologue à Montpellier | Consultations et Thérapie",
  description:
  ...
  twitter: {
    ...
    title: "Céline Castronovo - Psychologue à Montpellier",
    description:
      "Consultations et thérapie individuelle à Montpellier.",
    images: ["https://psychologie-montpellier.fr/images/celine_castronovo.webp"],
  },
...
export default function RootLayout({ children }) {
  return (
    <html lang="fr">
      ...
      <body className="m-0 p-0 w-screen h-screen relative bg-gray-100">{children}</body>
    </html>
  )
}
