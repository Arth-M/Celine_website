    ...
    <nav className={`fixed top-0 right-0 left-0 z-50 bg-gray-100 transition-opacity duration-200 ${
      ...
      <div className={`sm:hidden ${isMobileMenuOpen ? 'block' : 'hidden'}`}>
        <div className="space-y-1 px-2 pt-2 pb-3 bg-gray-100">
          <a href="#section-accueil" className="block rounded-md px-3 py-2 text-base font-medium text-teal-800 hover:bg-white/5 hover:text-white text-right" onClick={() => setIsMobileMenuOpen(false)}>Dashboard</a>
          <a href="#section-biography" className="block rounded-md px-3 py-2 text-base font-medium text-teal-800 hover:bg-white/5 hover:text-white text-right" onClick={() => setIsMobileMenuOpen(false)}>Team</a>
          <a href="#section-psycho" className="block rounded-md px-3 py-2 text-base font-medium text-teal-800 hover:bg-white/5 hover:text-white text-right" onClick={() => setIsMobileMenuOpen(false)}>Projects</a>
          <a href="#section-infos" className="block rounded-md px-3 py-2 text-base font-medium text-teal-800 hover:bg-white/5 hover:text-white text-right" onClick={() => setIsMobileMenuOpen(false)}>Calendar</a>
        </div>
      </div>
    </nav>
  );
