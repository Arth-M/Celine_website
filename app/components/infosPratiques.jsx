      ...
      <div className="flex flex-wrap">
        <div className="flex flex-col text-teal-900 mx-auto min-w-80 max-w-96 px-4 relative">
          ...
          <div className='flex flex-nowrap gap-x-4 my-2'>
            ...
            <a href="mailto:c.castronovo.34@gmail.com" className='text-start text-sm/6'>c.castronovo.34@gmail.com</a>
          </div>
          ...
          <div className="h-fit">
            <div className="w-fit relative my-4">
              ...
              <p className='text-start text-sm/6'>Consultation d'une heure : 60 € TTC</p>
            </div>
            <p className='text-start text-sm/6'>Dispositif Santé Psy Étudiants- 45 min : Nécessité de présenter un numéro INE</p>
          </div>

        </div>
        {/* google map */}
        <div className="mx-auto ">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2889.2971325847216!2d3.8646004118297057!3d43.6003545709841!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x12b6afd200cec417%3A0x176c4f90a36d217f!2sC%C3%A9line%20Castronovo!5e0!3m2!1sfr!2sfr!4v1758445164370!5m2!1sfr!2sfr" width="400" height="300" allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade" className='w-screen md:w-[400px] px-4 mt-6 lg:mt-16 object-scale-down'></iframe>
        </div>
      </div>
    </div>
  )
