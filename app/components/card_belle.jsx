  ...
  return (
    <div className="absolute -bottom-35 mx-auto left-0 right-0 w-[40%] min-w-[180px] md:w-[30%] 2xl:w-[20%]">
        <div className="mx-auto border border-gray-300/30 bg-white/40 h-fit p-(--card-padding) rounded-(--card-radius) [--card-radius:var(--radius-2xl)] [--card-padding:--spacing(0.5)]">
          <div className="mx-auto rounded-[calc(var(--card-radius)-var(--card-padding))] border bg-teal-600 border-gray-200 px-2 py-3">
            <Image
            ...
            />
            <p className="text-teal-50 mx-auto text-center w-fit no-wrap font-semibold">Céline Castronovo</p>
            <p className="text-teal-100 mx-auto text-center w-fit font-light">Psychologue</p>
            <p className="text-teal-200 mx-auto text-center w-fit font-light mt-2">EMDR, TCC</p>
            <p className="text-teal-300 mx-auto text-center w-fit font-light">Émotions, Cognition</p>
          </div>
        </div>
    </div>
  )
