...
export default function PourquoiConsulter() {
  ...
  let cardsNotOk =
    miniCardsContent.length % 3 != 0 ? miniCardsContent.length % 3 : false
    ...
    <div className="relative w-screen mt-35">
      <div className="container @container mx-auto px-8 mt-5 relative">
        <div className="text-teal-800 bg-transparent w-fit mx-auto mb-7">
          <h2
            id="pk-consulter-titre"
            className="invisible font-semibold text-center mb-2 text-lg tracking-wider @sm:w-sm @md:w-md @lg:w-lg @lg:mx-auto text-teal-800"
          >
            Pourquoi consulter ?
          </h2>
        </div>
      ...
      <div
        id="pk-consulter-texte"
        className="invisible container @container mx-auto px-8 mt-5 relative"
      >
        ...
        <div className="text-teal-800 p-5 w-fit mx-auto">
          <p className="@sm:w-xs @md:w-sm @lg:w-md @lg:mx-auto">
            ...
            Habituellement, on consulte un psy quand « ça ne va pas ». La
            démarche peut être mûrement réfléchie, mais il arrive aussi que le
            contexte soit oppressant... Quand votre couple rencontre des
            difficultés... Lorsque l'enfant arrive ou se fait attendre... Votre
